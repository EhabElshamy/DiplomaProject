...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1269753250ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=teachers">`graduation`.`teachers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=students">`graduation`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=login">`graduation`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=stages">`graduation`.`stages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=courses">`graduation`.`courses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=classes">`graduation`.`classes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=graduation&table=admins">`graduation`.`admins`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="23556b2c714823686d5259515f23606e">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="graduation" targettable="teachers">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teachers`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="graduation" targettable="students">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
